...
@section('contenido')
    @include('usuariosmercado.edit')
    @include('usuariosmercado.delete')
                ...
                <div class="card card-info card-outline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-4 col-md-4 col-xs-12">
                                <span class="" style="text-align: center;">
                                    <h3 class="card-title" >USUARIOS DEL MERCADO</h3>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8 md:w-1/3 px-3">
                                <div class="form-group">
                                    ...
                                    <a href="{{ url('usuarios-mercado/create') }}" class="btn btn-info btn-rounded waves-effect"
                            ...
                            <div class="col-sm-4" style="text-align:right">
                                @include('usuariosmercado.search')
                            </div>
                        </div>
                        ...
                        <div class="row">
                                                       ...
                                                       {{--  <td class="sorting_1">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="btn btn-danger" title="Eliminar"
                                                                ...
                                                                data-action="{{ route('usuarios-mercado.destroy', $usm->id) }}"
                                                                data-nombres="{{ $usm->nombres }}"
                                                                data-apellidos="{{ $usm->apellidos }}">
                            ...
                            <div class="row">
                            {{ $usuarios->appends(['searchT' => $query])->links()}}
                            </div>
                        </div>
                    </div>
                </div>
