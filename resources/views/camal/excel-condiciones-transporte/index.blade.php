                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6 md:w-1/3 px-3">
                                    {!!Form::open(array('url'=>'excel-condiciones-transporte','method'=>'POST','autocomplete'=>'off'))!!} 
                                          ...
                                          <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">           
                                            <label>Filtrar por día:</label>
                                                <div class="input-group date" id="timepicker" data-target-input="nearest">
                                                   <input type="text" class="form-control datetimepicker-input" value="" name="fecha_dia"  data-target="#timepicker"/>
                                ...
                                <div class="col-sm-6 md:w-1/3 px-3">
                                    {!!Form::open(array('url'=>'excel-condiciones-transporte-mes','method'=>'POST','autocomplete'=>'off'))!!} 
                                    <fieldset class="form-group">
                                        <div class="row">
