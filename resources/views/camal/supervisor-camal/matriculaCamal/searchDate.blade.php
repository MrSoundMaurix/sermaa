{!! Form::open(array('url'=>'/matricula-camal','method'=>'GET','autocomplete'=>'off','role'=>'searchDate')) !!}
...
{{Form::close()}}
             {!! Form::open(array('url'=>'/matricula-camal/pdfmatriculascamal','method'=>'POST','autocomplete'=>'off','role'=>'searchDate')) !!}
            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <label>PDF:</label>  <br>
              <input type="hidden" name="matriculaMercado1" value="{{$matriculas_camal1}}"/>
