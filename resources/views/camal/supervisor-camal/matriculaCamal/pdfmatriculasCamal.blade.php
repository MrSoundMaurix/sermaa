...
<body>
    ...
    <br>
    <div class="col-md-12" style="text-align: center;"><strong><p style="font-size: 0.8em"> REPORTE DE REGISTROS DE USUARIOS MATRICULADOS DE LA PLANTA </p></strong></div>
    <br>
        ...
        <tbody>
            ...
            @for ($i = 0; $i < $ff; $i++)
                <tr>
                    ...
                    @if($matriculasPdf[$i]->id_users==$user->id){
