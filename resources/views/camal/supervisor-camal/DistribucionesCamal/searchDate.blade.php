{!! Form::open(array('url'=>'/supervisorcamal-distribucion','method'=>'GET','autocomplete'=>'off','role'=>'searchDate')) !!}
...
{{Form::close()}}
             {!! Form::open(array('url'=>'/supervisorcamal-distribucion/pdfdistribucionescamal','method'=>'POST','autocomplete'=>'off','role'=>'searchDate')) !!}
            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <label>PDF:</label>  <br>
              <input type="hidden" name="distribucionCamal1" value="{{$distribuciones_camal1}}"/> 
              <input type="hidden" name="totalRecaudado" value="{{$totalRecaudadoD}}"/>
