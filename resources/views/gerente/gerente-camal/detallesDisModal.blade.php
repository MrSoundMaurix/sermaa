<div class="modal fade" id="detallesDis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" style="" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="card-title">PESOS</h3>
...
@push('scripts')
<script >
$('#detallesDis').on('show.bs.modal', function (event) {
     ...
     //  var p= JSON.parse(pesos)
        console.log(tipopieza);
         detallesDis(tipopieza,id_usuario,id_ingresos) ;
          }); 
          
          function  detallesDis(tipopieza,id_usuario,id_ingresos) {
            if ($.trim(tipopieza) != '') {
                console.log(tipopieza);
