		...
		<div class="content">
			...
			<div class="card card-info card-outline">
                <div class="card">
					...
					{!! Form::open(['url' => 'superadmin-personal-mercado', 'files'=>'true']) !!}
						<div class="card-body">
												...
												@if($roles != null)
													@foreach ($roles as $rol)
														<option value="{{$rol->id}}" {{ (old('team') == $rol->id ? "selected":"") }}>
															...
															<?php if($rol->name=='operario_mercado'){
																echo "Recaudador";}
																else if($rol->name=='supervisor_mercado'){
																	echo "Supervisor";
																}
															?>
														</option>
						...
						<div class="modal-footer">
							<div class="form-group form-actions">
								<a class="btn btn-danger" href="{{url('superadmin-personal-mercado')}}">Cancelar</a> 
