...
@section('contenido')
    @include('superadministrador.personal-mercado.edit')
    @include('superadministrador.personal-mercado.delete')
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">PERSONAL DEL MERCADO</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 md:w-1/3 px-3">
                                <span class="fa fa-cicle-o"></span>
                                <a href="{{ url('superadmin-personal-mercado/create') }}" class="btn btn-info btn-rounded waves-effect"
                                    title="Añadir Nuevo Usuario">
                                    <span class="fa fa-plus-square"></span> Nuevo personal
                                </a>
                            </div>
                            <div class="col-sm-6" style="text-align:right">
                                @include('superadministrador/personal-mercado.search')
                            </div>
                        </div>
                                                       ...
                                                       {{--  <td class="sorting_1">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="btn btn-danger" title="Eliminar"
                                                                ...
                                                                data-action="{{ route('superadmin-personal-mercado.destroy', $usm->id) }}"
                                                                data-nombres="{{ $usm->nombres }}"
                                                                data-apellidos="{{ $usm->apellidos }}">
