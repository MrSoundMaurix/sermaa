		...
		<div class="content">
			...
			<div class="card card-info card-outline">
                <div class="card">
					...
					{!! Form::open(['url' => 'superadmin-personal', 'files'=>'true']) !!}
						<div class="card-body">
														...
														<option value="{{$rol->id}}" {{ (old('team') == $rol->id ? "selected":"") }}>
															...
															<?php if($rol->name=='operario_camal'){
																echo "Faenador";}
																	...
																	echo "Administrador";
																}else if($rol->name=='supervisor_camal') {
																	echo "Supervisor";
																}else if($rol->name=='gerente') {
																	echo "Gerente";
																}else if($rol->name=='veterinario') {
																	echo "Veterinario";
																}
															?>
														</option>
						...
						<div class="modal-footer">
							<div class="form-group form-actions">
								<a class="btn btn-danger" href="{{url('superadmin-personal')}}">Cancelar</a> 
