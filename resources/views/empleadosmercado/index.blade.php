                        ...
                        <div class="row">
                            <div class="col-sm-8 md:w-1/3 px-3">
                                <div class="form-group">
                                    ...
                                    <a href="{{ url('empleados-mercado/create') }}" class="btn btn-info btn-rounded waves-effect"
                            ...
                            @include('empleadosmercado.search')
                            </div>
                        </div>
                                                       ...
                                                       {{--  <td class="sorting_1">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="btn btn-danger" title="Eliminar"
                                                                ...
                                                                data-action="{{ route('empleados-mercado.destroy', $usm->id) }}"
                                                                data-nombres="{{ $usm->nombres }}"
                                                                data-apellidos="{{ $usm->apellidos }}">
